...
fist_threshold = 0.05 # Adjust as necessary
#distince +/- 1m with 0.05 and working 
        ...
        for hand_landmarks in output_hands.multi_hand_landmarks:
            ...
            if fist_detected:
                ...
                if fist_frame_count >= fist_confirmation_frames:
                    ...
                    fist_frame_count = 0  # Reset the counter after a click
            else:
                fist_frame_count = 0  # Reset the counter if a fist is not detected
